...
def training_loop(model, criterion, optimizer, patience, dataloader_train, dataloader_val, epochs, mclstm=False):
    """
    ...
    mclstm -- bool, whether or not using mclstm architecture (separate auxillary and mass input)
