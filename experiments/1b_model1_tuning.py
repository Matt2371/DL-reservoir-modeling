...
def grid_search_1b(dataloader_train, dataloader_val):
...
def train_optimal_model_1b(dataloader_train, dataloader_val):
...
if __name__ == '__main__':
    # data processing
    dataloader_train, dataloader_val = data_processing_1b(name='Shasta', transform_type='normalize')

    # # grid search
    # grid_search_1b(dataloader_train=dataloader_train, dataloader_val=dataloader_val)

    # save optimal model
    train_optimal_model_1b(dataloader_train=dataloader_train, dataloader_val=dataloader_val)
